...
function FindingNew() {
  ...
  function handleCreate() {
    ...
    async function create() {
      await api.post(`/vessels/${id}/findings`, {
        comments: obs,
      });
      // navigate("FindingsData", {id});
      goBack()
    ...
    Alert.alert(
      "",
      "Você quer mesmo criar novo achado com esses dados?",
      [
        {
          text: "Cancelar",
        },
    ...
    <>
      ...
      >
        ...
        <View style={styles.titleBox}>
          <Text style={styles.titleText}>Novo Achado</Text>
        </View>
